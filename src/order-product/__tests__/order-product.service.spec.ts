...
describe('OrderProductService', () => {
  ...
  it('should return order product in save', async () => {
    ...
    const orderProduct = await service.createOrderProduct(productMock.id, orderMock.id, orderProductMock.price, orderProductMock.amount)
  ...
  it('should return exception in error db', async () => {
    ...
    expect(service.createOrderProduct(productMock.id, orderMock.id, orderProductMock.price, orderProductMock.amount)).rejects.toThrowError()
  });
